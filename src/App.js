    ...
    return (
      ...
      />
        ...
        <Routes>
          ...
          <Route exact path="/health" elemnt={<News setProgress={this.setProgress} key="health" pageSize={this.pageSize} country="in" category="health"/>} />
          ...
          <Route exact path="/technology" elenent={<News setProgress={this.setProgress} key="technology" pageSize={this.pageSize} country="in" category="technology"/>} /> 
